...
# OUTPUT_FILEPATH = CWD / f"ARGneural/drug_and_mechanism_pred.png"
...
OUTPUT_FILEPATH = CWD / f"ARGneural/drug_and_mechanism_pred_{THRESHOLD}.png"
...
def main(args):
    ...
    for epoch in range(num_epochs):
        ...
        for pred, drug in zip(valid_all_predictions, validation_loader.dataset.drug_class):
