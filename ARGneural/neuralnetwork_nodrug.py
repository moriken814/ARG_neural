...
class Encoder_for_classification(nn.Module):
    def __init__(self, d_model=128, dropout_rate=0.2):
        ...
        self.num_output_classes = len(mechanism_labels)     # num of mechanism_labels (7)
    ...
    def forward(self, src, drug_class, species):
        ...
        combined_input = torch.cat((src_normalized, species_normalized), dim=1)  # [Batch, 640(512 + d_model)]
